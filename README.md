...
| 天色 / 天气预览 | 齿轮里选，或 `?time=night&weather=rain`（`time=day` / `dusk`，`weather=clear` / `cloudy` / `fog`；也可用 `?hour=21`） |
...
- **mid**：默认；软焦散、中等涟漪；可见雨丝；鱼被水面折射
- **high**：更密涟漪、更高 DPR，4K 上更清晰也更耗电；雨丝更多，折射略强
